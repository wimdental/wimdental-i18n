...
exports.default = function (dictionary, locale, entry, args) {
    ...
    if (typeof entryValue === 'function') {
        ...
        if (typeof result !== 'string' && !_react2.default.isValidElement(result)) {
            throw new Error('Locale entry ' + currentLocale + '.data.' + entry + ' should return a string or React component.');
        }
        ...
        throw new Error('Locale entry ' + currentLocale + '.data.' + entry + ' must be a string or React component.');
    }
};